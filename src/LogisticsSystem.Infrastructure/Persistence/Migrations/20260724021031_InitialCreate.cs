        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupLatitude = table.Column<double>(type: "float(9)", precision: 9, scale: 6, nullable: false),
                    PickupLongitude = table.Column<double>(type: "float(9)", precision: 9, scale: 6, nullable: false),
                    DeliveryAddress = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    DeliveryLatitude = table.Column<double>(type: "float(9)", precision: 9, scale: 6, nullable: false),
                    DeliveryLongitude = table.Column<double>(type: "float(9)", precision: 9, scale: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DispatchAssignments_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DispatchAssignments_Shipments_ShipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DispatchAssignments_DriverId",
                table: "DispatchAssignments",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_DispatchAssignments_ShipmentId",
                table: "DispatchAssignments",
                column: "ShipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_DispatchAssignments_ShipmentId_DriverId_AttemptNumber",
                table: "DispatchAssignments",
                columns: new[] { "ShipmentId", "DriverId", "AttemptNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DispatchAssignments_Status",
                table: "DispatchAssignments",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipmentTrackings_RecordedAt",
